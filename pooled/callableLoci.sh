...
java -Xmx4g -jar /opt/PepPrograms/RGAPipeline/GenomeAnalysisTK.jar -T CallableLoci -I ERR867518.realn.patrealn.bam -summary ERR867518_strict.summary -o ERR867518_strict.bed -R /opt/data/mtuberculosis/MtbNCBIH37Rv.fa -frimq 0.04 -mmq 20
