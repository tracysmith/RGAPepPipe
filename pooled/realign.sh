...
java -Xmx4g -jar /opt/PepPrograms/RGAPipeline/GenomeAnalysisTK.jar -T IndelRealigner -R /opt/data/mtuberculosis/MtbNCBIH37Rv.fa -I ERR867518.realn.bam -targetIntervals ERR867518.intervals -nWayOut .patrealn.bam
